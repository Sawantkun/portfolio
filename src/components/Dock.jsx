...
const T_COMMANDS = {
  ...
  whoami: () => [
    L('Sawant Kumar', 'heading'), L('Full Stack Web Developer', 'accent'), HR(), BL(),
    L('  Results-driven developer building immersive,', 'body'),
    L('  user-centric web experiences with React.js,', 'body'),
    L('  Next.js, Tailwind, and more.', 'body'), BL(),
